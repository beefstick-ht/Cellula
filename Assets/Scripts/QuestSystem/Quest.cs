...
public class Quest
{
    ...
    private GameObject GetCurrentQuestStepPrefab()
    {
        ...
        {
            Debug.LogWarning("Tried to get quest step prefab, but stepIndex was out of range indicating that theres no current step: QuestId =" + info.id + ", stepIndex" + currentQuestStepIndex);
        }
